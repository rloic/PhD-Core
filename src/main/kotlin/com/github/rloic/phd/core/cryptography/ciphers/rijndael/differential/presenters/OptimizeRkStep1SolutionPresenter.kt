...
import com.github.rloic.phd.core.cryptography.ciphers.rijndael.differential.solutions.OptimizeRkStep1Solution
import com.github.rloic.phd.core.utils.Presenter

class OptimizeRkStep1SolutionPresenter(private val out: Appendable) : Presenter<OptimizeRkStep1Solution> {
    override fun present(data: OptimizeRkStep1Solution) {
